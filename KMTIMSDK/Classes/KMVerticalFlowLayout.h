...
@class KMVerticalFlowLayout;

@protocol KMVerticalFlowLayoutDelegate <NSObject>
 ...
 * 距离collectionView四周的间距, 默认{20, 10, 10, 10}
 ...
 @return  UIEdgeInsets
 */
- (UIEdgeInsets)km_waterflowLayout:(KMVerticalFlowLayout *)waterflowLayout edgeInsetsInCollectionView:(UICollectionView *)collectionView;

@end

@interface KMVerticalFlowLayout : UICollectionViewLayout
